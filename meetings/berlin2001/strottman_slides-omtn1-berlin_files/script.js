...
var gDocTable = new Array(
   ...
   new hrefList("slide0027.htm", 1, 5),
   ...
   new hrefList("slide0031.htm", 1, 11),
   new hrefList("slide0030.htm", 1, 12),
   new hrefList("slide0056.htm", 1, 13),
   new hrefList("slide0032.htm", 1, 14),
   new hrefList("slide0033.htm", 1, 15),
   new hrefList("slide0039.htm", 1, 16),
   new hrefList("slide0040.htm", 1, 17),
   new hrefList("slide0057.htm", 1, 18),
   new hrefList("slide0042.htm", 1, 19),
   new hrefList("slide0044.htm", 1, 20),
   new hrefList("slide0045.htm", 1, 21),
   new hrefList("slide0046.htm", 1, 22),
   new hrefList("slide0054.htm", 1, 23),
   new hrefList("slide0043.htm", 1, 24),
