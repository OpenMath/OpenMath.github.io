...
var gDocTable = new Array(
   new hrefList("slide0074.htm", 1, 1),
   new hrefList("slide0182.htm", 1, 2),
   new hrefList("slide0132.htm", 1, 3),
   new hrefList("slide0133.htm", 1, 4),
   new hrefList("slide0134.htm", 1, 5),
   new hrefList("slide0135.htm", 1, 6),
   new hrefList("slide0136.htm", 1, 7),
   new hrefList("slide0137.htm", 1, 8),
   new hrefList("slide0167.htm", 1, 9),
   new hrefList("slide0142.htm", 1, 10),
   new hrefList("slide0191.htm", 1, 11),
   new hrefList("slide0192.htm", 1, 12),
   new hrefList("slide0143.htm", 1, 13),
   new hrefList("slide0149.htm", 1, 14),
   new hrefList("slide0150.htm", 1, 15),
   new hrefList("slide0214.htm", 1, 16),
   new hrefList("slide0208.htm", 1, 17),
   new hrefList("slide0210.htm", 1, 18),
   new hrefList("slide0187.htm", 1, 19),
   new hrefList("slide0188.htm", 1, 20),
   new hrefList("slide0199.htm", 1, 21),
   new hrefList("slide0200.htm", 1, 22),
   new hrefList("slide0201.htm", 1, 23),
   new hrefList("slide0205.htm", 1, 24),
   new hrefList("slide0206.htm", 1, 25),
   new hrefList("slide0207.htm", 1, 26),
   new hrefList("slide0146.htm", 1, 27),
   new hrefList("slide0177.htm", 1, 28),
   new hrefList("slide0169.htm", 1, 29),
   new hrefList("slide0211.htm", 1, 30),
   new hrefList("slide0212.htm", 1, 31),
   new hrefList("slide0193.htm", 1, 32)
);
